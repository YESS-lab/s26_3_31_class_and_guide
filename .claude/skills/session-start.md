---
name: session-start
description: Routes incoming user messages to the appropriate mindful consumption skill based on intent classification
---
...
|--------------|----------|
| Expresses desire to buy, acquire, or "need" something | `want-examination` skill |
| Mentions advertising, social media comparison, "everyone has X," feeling pressured | `reframe` skill |
| Expresses stress, low mood, burnout, or asks for self-care | `flourishing-prompt` skill |
| General check-in, wants to reflect on what they have, gratitude | `gratitude-inventory` skill |
